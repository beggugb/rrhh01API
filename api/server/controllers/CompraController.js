                                    ...
                                    Promise.all([
                                        ...
                                        .then(([xycompra,xyitems])=>{
                                            ...
                                            Promise.all([                                                
                                                ...
                                                .then(([xcomprobante,xconta,xmovimiento])=>{
                                                    let newMovi = xyitems.map((it,index)=>{
                                                        let iok = {
                                                            "movimientoId" : xmovimiento,
                                                            "cantidad"     : it.cantidad,  
                                                            "codigo"       : it.codigo,
                                                            "valor"        : parseFloat(it.valor),                                                                                                                        
                                                            "articuloId"   : it.articuloId                                                            
                                                    ...
                                                    Promise.all([
                                                        MovimientoItemService.setAdd(newMovi),
                                                        CompraService.getData(1,15,'compra')
                                                    ])
