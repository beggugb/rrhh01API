  ...
  static getItemsSingle(movimiento){
    return new Promise((resolve,reject) =>{          
      MovimientoItem.findAll({
          ...
          attributes:["id","articuloId","codigo","valor","categoria","marca","cantidad","movimientoId"]               
        })
  ...
  static getItems(movimiento){
    return new Promise((resolve,reject) =>{          
      MovimientoItem.findAll({
          ...
          order: [['id','ASC']],
          where: { movimientoId: movimiento},
          attributes:["id","articuloId","codigo","unidad","valor","subTotal","categoria","marca","cantidad","movimientoId"],
          include:[{
